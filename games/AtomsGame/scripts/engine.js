...
function play(){
    ...
    if(GameStatus == Status.start) {
        ...
        canvas.onclick = function(event){
            ...
            GRAVITY = 2;
            elementSort();
            alert("Hey, This game is in portuguese. In this game you must select the element that is presented by the cat (to the left of the screen). You initially have three lives and as you miss a presented element, you lose one life. For each element hit, one point! \n\n Have a good time! :\) \n\n\n This game was developed by Allex Lima, Daniel Bispo, Paulo Moraes and Renan Barroncas, students of the 4th period (2015) of the Computer Engineering course at UniNorte Laureate.\n\n Advisor: Profª Drª Rebecca Freire.\n")
